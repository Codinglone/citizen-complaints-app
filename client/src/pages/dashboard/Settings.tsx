...
export const Settings: React.FC = () => {
  ...
  // Determine if we're in the admin panel by checking URL path
  ...
  // Get role display text based on URL path rather than profile role
  const getRoleDisplayText = () => {
    // If we're in admin section, always show admin role
    if (isAdminPanel) {
      return t("role.admin");
    }
    // Otherwise use the default citizen role
  ...
  return (
    <div>
      ...
      <div className="card bg-base-200 shadow-xl mb-6">
        <div className="card-body">
          <h2 className="card-title mb-4">
            {t("userDashboard.profileInformation")}
          </h2>
              ...
              <div className="form-control flex flex-col gap-y-4">
                ...
                <label className="label">
                  <span className="label-text-alt">
                    {t("userDashboard.emailCannotChange")}
                  </span>
                </label>
              </div>
      ...
      <div className="card bg-base-200 shadow-xl mb-6">
        <div className="card-body">
          <h2 className="card-title mb-4">
            {t("userDashboard.notificationPreferences")}
          </h2>
          ...
          <div className="card-actions justify-end mt-6">
            <button className="btn btn-primary">
              {t("userDashboard.savePreferences")}
            </button>
          </div>
        </div>
      </div>
      ...
      <div className="card bg-base-200 shadow-xl">
        <div className="card-body">
          ...
          <button className="btn btn-outline mb-3 w-full max-w-md">
            {t("userDashboard.changePassword")}
          </button>
          <button className="btn btn-outline mb-3 w-full max-w-md">
            {t("userDashboard.enableTwoFactor")}
          </button>

          <div className="border-t border-base-300 my-6"></div>

          <h3 className="font-semibold text-error mb-3">
            {t("userDashboard.dangerZone")}
          </h3>
          <button className="btn btn-outline btn-error w-full max-w-md">
